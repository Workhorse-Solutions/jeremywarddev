...
# docker build -t railsfoundry .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name railsfoundry railsfoundry
...
ENV RAILS_ENV="production" \
    ...
    BUNDLE_WITHOUT="development:foundry_cli" \
